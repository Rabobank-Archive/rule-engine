...
import nl.rabobank.rules.dsl.nl.grammar.{DslCondition, DslEvaluation}
import nl.rabobank.rules.engine.{ProjectionEvaluation, ProjectionListEvaluation, SingularFactEvaluation, _}
import nl.rabobank.rules.facts.{Fact, ListFact}
