...
import nl.rabobank.oss.rules.services.{HeuristicService, _}

//scalastyle:off null

class InternalHeuristicTester(heuristicService: HeuristicService, verplichteBerekening: Berekening, optioneleBerekeningen: Berekening*)
  extends InternalBerekeningenTester(verplichteBerekening, optioneleBerekeningen:_*) {
